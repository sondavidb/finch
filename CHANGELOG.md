...
## [1.0.1](https://github.com/sondavidb/finch/compare/v1.4.1...v1.0.1) (2024-11-07)


### Build System or External Dependencies

* **deps:** Bump github.com/aws/aws-sdk-go-v2 from 1.21.2 to 1.22.0 ([#677](https://github.com/sondavidb/finch/issues/677)) ([c450dc9](https://github.com/sondavidb/finch/commit/c450dc96b5f09b57adcf48a62c09138bc04f3df5))
* **deps:** Bump github.com/aws/aws-sdk-go-v2 from 1.22.0 to 1.22.1 ([#682](https://github.com/sondavidb/finch/issues/682)) ([2537aa6](https://github.com/sondavidb/finch/commit/2537aa6490f411551f162255d152805cb5c47951))
* **deps:** Bump github.com/aws/aws-sdk-go-v2 from 1.22.1 to 1.23.5 ([#716](https://github.com/sondavidb/finch/issues/716)) ([feedd95](https://github.com/sondavidb/finch/commit/feedd953825f8736736fa6c796a4bb72cf70aabd))
* **deps:** Bump github.com/aws/aws-sdk-go-v2 from 1.23.5 to 1.24.0 ([#729](https://github.com/sondavidb/finch/issues/729)) ([963d278](https://github.com/sondavidb/finch/commit/963d278df6cfb2c660f25601a916293b29d51bc8))
* **deps:** Bump github.com/aws/aws-sdk-go-v2 from 1.24.0 to 1.24.1 ([#749](https://github.com/sondavidb/finch/issues/749)) ([c3ae967](https://github.com/sondavidb/finch/commit/c3ae96794165b4ea696bb94856d40ff91767ed1b))
* **deps:** Bump github.com/aws/aws-sdk-go-v2 from 1.25.0 to 1.25.2 ([#831](https://github.com/sondavidb/finch/issues/831)) ([9eb8097](https://github.com/sondavidb/finch/commit/9eb80975c7490394d5af082b2738dda7d3090fe1))
* **deps:** Bump github.com/aws/aws-sdk-go-v2 from 1.25.2 to 1.25.3 ([#856](https://github.com/sondavidb/finch/issues/856)) ([e9314f0](https://github.com/sondavidb/finch/commit/e9314f0e5de309d95e51878a655eceec1e319141))
...
* **deps:** Bump github.com/containerd/containerd from 1.7.10 to 1.7.11 ([#742](https://github.com/sondavidb/finch/issues/742)) ([7d1e250](https://github.com/sondavidb/finch/commit/7d1e25068a503a8b4ea7dd3f349ff4020168a6fb))
...
* **deps:** Bump github.com/docker/cli from 24.0.4+incompatible to 24.0.5+incompatible ([#495](https://github.com/sondavidb/finch/issues/495)) ([e9e8617](https://github.com/sondavidb/finch/commit/e9e8617b07301848dc1f6c3afa18643d212d024e))
* **deps:** Bump github.com/docker/cli from 24.0.5+incompatible to 24.0.6+incompatible ([#560](https://github.com/sondavidb/finch/issues/560)) ([21bb893](https://github.com/sondavidb/finch/commit/21bb893105f0a4fc5541e3a8e9f5306edb739154))
* **deps:** Bump github.com/docker/cli from 24.0.6+incompatible to 24.0.7+incompatible ([#665](https://github.com/sondavidb/finch/issues/665)) ([43a57ff](https://github.com/sondavidb/finch/commit/43a57ffc052ba1ffcf0f50cdb08dfdb42abc9723))
* **deps:** Bump github.com/docker/cli from 25.0.3+incompatible to 25.0.4+incompatible ([#857](https://github.com/sondavidb/finch/issues/857)) ([838fc07](https://github.com/sondavidb/finch/commit/838fc07ee4ec22977606a28ea36b267788ace94d))
* **deps:** Bump github.com/docker/cli from 25.0.4+incompatible to 26.0.0+incompatible ([#867](https://github.com/sondavidb/finch/issues/867)) ([4167d3d](https://github.com/sondavidb/finch/commit/4167d3dd61865b22bca9e7c54f839ba1d90138bf))
...
* **deps:** Bump github.com/docker/docker from 23.0.3+incompatible to 23.0.5+incompatible ([#382](https://github.com/sondavidb/finch/issues/382)) ([3e0581c](https://github.com/sondavidb/finch/commit/3e0581cc0f86efcd9ce7b7dc8c9384fb1e6af785))
* **deps:** Bump github.com/docker/docker from 23.0.5+incompatible to 23.0.6+incompatible ([#394](https://github.com/sondavidb/finch/issues/394)) ([f44bc2e](https://github.com/sondavidb/finch/commit/f44bc2eb14011640f7a25218bbc18a82d533e76a))
* **deps:** Bump github.com/docker/docker from 23.0.6+incompatible to 24.0.0+incompatible ([#406](https://github.com/sondavidb/finch/issues/406)) ([25aa324](https://github.com/sondavidb/finch/commit/25aa324ca324248cf2093af23f205af1b5ae276f))
* **deps:** Bump github.com/docker/docker from 24.0.0+incompatible to 24.0.1+incompatible ([#413](https://github.com/sondavidb/finch/issues/413)) ([bb1cab2](https://github.com/sondavidb/finch/commit/bb1cab229c787752615eb00e74f240c4a4e0e23d))
* **deps:** Bump github.com/docker/docker from 24.0.1+incompatible to 24.0.2+incompatible ([#419](https://github.com/sondavidb/finch/issues/419)) ([f6f8aeb](https://github.com/sondavidb/finch/commit/f6f8aeb40fa0b2cfaa807c98eb3576ca262d75aa))
* **deps:** Bump github.com/docker/docker from 24.0.2+incompatible to 24.0.4+incompatible ([#469](https://github.com/sondavidb/finch/issues/469)) ([ad37f4f](https://github.com/sondavidb/finch/commit/ad37f4fbce72a6f479620461127e8fe494d47cad))
* **deps:** Bump github.com/docker/docker from 24.0.2+incompatible to 24.0.4+incompatible ([#481](https://github.com/sondavidb/finch/issues/481)) ([15d2a4b](https://github.com/sondavidb/finch/commit/15d2a4bf8cfd3956a2f8bb4878bfb86827b4e77d))
* **deps:** Bump github.com/docker/docker from 24.0.4+incompatible to 24.0.5+incompatible ([#497](https://github.com/sondavidb/finch/issues/497)) ([6f1afbb](https://github.com/sondavidb/finch/commit/6f1afbb69554148efd8eea938278bcc5104ab050))
* **deps:** Bump github.com/docker/docker from 24.0.5+incompatible to 24.0.6+incompatible ([#561](https://github.com/sondavidb/finch/issues/561)) ([e0160be](https://github.com/sondavidb/finch/commit/e0160be4b90b9db0e9e544a8ad9b170c08b38756))
* **deps:** Bump github.com/docker/docker from 24.0.6+incompatible to 24.0.7+incompatible ([#666](https://github.com/sondavidb/finch/issues/666)) ([4e06d28](https://github.com/sondavidb/finch/commit/4e06d283512ed851279cb4988089f1c610896ba9))
* **deps:** Bump github.com/docker/docker from 24.0.7+incompatible to 25.0.1+incompatible ([#772](https://github.com/sondavidb/finch/issues/772)) ([b16f6ae](https://github.com/sondavidb/finch/commit/b16f6aeb31473ce2e49550827d7a1974fd719e0d))
* **deps:** Bump github.com/docker/docker from 25.0.1+incompatible to 25.0.3+incompatible ([#799](https://github.com/sondavidb/finch/issues/799)) ([d761301](https://github.com/sondavidb/finch/commit/d7613012551bd47c26476a993a35856aab91511c))
* **deps:** Bump github.com/docker/docker from 25.0.3+incompatible to 25.0.4+incompatible ([#845](https://github.com/sondavidb/finch/issues/845)) ([769ae32](https://github.com/sondavidb/finch/commit/769ae321828eb5842943a2bf503297543551bdfe))
...
* **deps:** Bump github.com/goccy/go-yaml from 1.11.2 to 1.11.3 ([#780](https://github.com/sondavidb/finch/issues/780)) ([2e616ff](https://github.com/sondavidb/finch/commit/2e616ff18d68931f0da81a04045960f035568322))
* **deps:** Bump github.com/lima-vm/lima from 0.15.1 to 0.16.0 ([#428](https://github.com/sondavidb/finch/issues/428)) ([6a67f0c](https://github.com/sondavidb/finch/commit/6a67f0cfb0a3a1da438779f4faa04048f25d7dde))
* **deps:** Bump github.com/lima-vm/lima from 0.16.0 to 0.17.2 ([#531](https://github.com/sondavidb/finch/issues/531)) ([6e33d15](https://github.com/sondavidb/finch/commit/6e33d159e2f522784860bc60ceea897a98d1fe5f))
* **deps:** Bump github.com/lima-vm/lima from 0.17.2 to 0.18.0 ([#643](https://github.com/sondavidb/finch/issues/643)) ([f181b89](https://github.com/sondavidb/finch/commit/f181b8970c6d63a25d22be44820d1570c95b6f41))
* **deps:** Bump github.com/lima-vm/lima from 0.18.0 to 0.19.0 ([#721](https://github.com/sondavidb/finch/issues/721)) ([2058164](https://github.com/sondavidb/finch/commit/20581647a1949e7e9d258e851dd25a1105168410))
* **deps:** Bump github.com/lima-vm/lima from 0.19.0 to 0.20.0 ([#769](https://github.com/sondavidb/finch/issues/769)) ([7f0c86e](https://github.com/sondavidb/finch/commit/7f0c86e208a2d6faf3a93ed72887a7211fb9aa9f))
* **deps:** Bump github.com/lima-vm/lima from 0.20.1 to 0.20.2 ([#855](https://github.com/sondavidb/finch/issues/855)) ([99d4c3c](https://github.com/sondavidb/finch/commit/99d4c3cd8d1623b70c859077fbe7e07a69cf9853))
* **deps:** Bump github.com/lima-vm/lima from 0.20.2 to 0.21.0 ([#862](https://github.com/sondavidb/finch/issues/862)) ([120ffcc](https://github.com/sondavidb/finch/commit/120ffccf2bb85fa0f5dd1c8907e9f8ecc70eb416))
...
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.10.0 to 2.11.0 ([#456](https://github.com/sondavidb/finch/issues/456)) ([f7e0916](https://github.com/sondavidb/finch/commit/f7e091670fb2ac5377423e72f98aa8be33aa41c8))
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.11.0 to 2.12.0 ([#542](https://github.com/sondavidb/finch/issues/542)) ([8536481](https://github.com/sondavidb/finch/commit/85364818e9f5a9ca1993fa7a3fc8ce775e002a42))
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.13.1 to 2.13.2 ([#708](https://github.com/sondavidb/finch/issues/708)) ([cbbd064](https://github.com/sondavidb/finch/commit/cbbd0645aaa5164ffe9eb31d1d1ab7220a50a03e))
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.13.2 to 2.14.0 ([#758](https://github.com/sondavidb/finch/issues/758)) ([7d3a7c8](https://github.com/sondavidb/finch/commit/7d3a7c84b02d70edad7947573f77dada22332f41))
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.15.0 to 2.16.0 ([#842](https://github.com/sondavidb/finch/issues/842)) ([8e04421](https://github.com/sondavidb/finch/commit/8e044217f97b9fe8b4557e5770eb2b383768c413))
...
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.9.2 to 2.9.3 ([#390](https://github.com/sondavidb/finch/issues/390)) ([7102994](https://github.com/sondavidb/finch/commit/710299445ed287c67114b277be7bd2a29715956b))
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.9.3 to 2.9.5 ([#400](https://github.com/sondavidb/finch/issues/400)) ([65458f1](https://github.com/sondavidb/finch/commit/65458f1b0c20705e724ac07356d87dd47ae2000c))
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.9.5 to 2.9.7 ([#432](https://github.com/sondavidb/finch/issues/432)) ([0a381f1](https://github.com/sondavidb/finch/commit/0a381f17ea2602bc3b19f9b2101da9e3a589f6d3))
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.9.7 to 2.10.0 ([#449](https://github.com/sondavidb/finch/issues/449)) ([a415e3e](https://github.com/sondavidb/finch/commit/a415e3ef7b2741853bf352b915c4100c77600619))
* **deps:** Bump github.com/onsi/gomega from 1.27.10 to 1.28.0 ([#583](https://github.com/sondavidb/finch/issues/583)) ([9d1ad57](https://github.com/sondavidb/finch/commit/9d1ad5748967b8b978131ddb50071200fcceffde))
* **deps:** Bump github.com/onsi/gomega from 1.27.6 to 1.27.7 ([#409](https://github.com/sondavidb/finch/issues/409)) ([80513c7](https://github.com/sondavidb/finch/commit/80513c7785a6da4ae09d9c871acaf180f5d68f2c))
* **deps:** Bump github.com/onsi/gomega from 1.27.7 to 1.27.8 ([#448](https://github.com/sondavidb/finch/issues/448)) ([96fc8d0](https://github.com/sondavidb/finch/commit/96fc8d09a051b2ead932e6eef064624b1a842b66))
* **deps:** Bump github.com/onsi/gomega from 1.27.8 to 1.27.10 ([#496](https://github.com/sondavidb/finch/issues/496)) ([d08d102](https://github.com/sondavidb/finch/commit/d08d102d05a350a8b8e586c42ef83d51495cf4f9))
* **deps:** Bump github.com/onsi/gomega from 1.28.0 to 1.29.0 ([#662](https://github.com/sondavidb/finch/issues/662)) ([5c9de37](https://github.com/sondavidb/finch/commit/5c9de37cb8ba8a4d5cabfe3c640239bd1afa87e0))
* **deps:** Bump github.com/onsi/gomega from 1.29.0 to 1.30.0 ([#693](https://github.com/sondavidb/finch/issues/693)) ([2b0c54c](https://github.com/sondavidb/finch/commit/2b0c54c85a227bdca0189a3e96b9981289759f53))
* **deps:** Bump github.com/onsi/gomega from 1.30.0 to 1.31.1 ([#768](https://github.com/sondavidb/finch/issues/768)) ([889abf8](https://github.com/sondavidb/finch/commit/889abf8d7b8fa795790e509cbc00886dedce5af6))
* **deps:** Bump github.com/onsi/gomega from 1.31.1 to 1.32.0 ([#860](https://github.com/sondavidb/finch/issues/860)) ([b2c9449](https://github.com/sondavidb/finch/commit/b2c94497ec1c950dfe909265f13d70c8c0f8fed9))
...
* **deps:** Bump github.com/pkg/sftp from 1.13.5 to 1.13.6 ([#530](https://github.com/sondavidb/finch/issues/530)) ([09b3846](https://github.com/sondavidb/finch/commit/09b38467333e5e59eadb76cd5f4612768cde5289))
...
* **deps:** Bump github.com/runfinch/common-tests from 0.6.5 to 0.7.0 ([#420](https://github.com/sondavidb/finch/issues/420)) ([ac18046](https://github.com/sondavidb/finch/commit/ac18046e70efc0e1e9fe11a30457f6f945df2a23))
* **deps:** Bump github.com/runfinch/common-tests from 0.7.0 to 0.7.1 ([#477](https://github.com/sondavidb/finch/issues/477)) ([54c03bb](https://github.com/sondavidb/finch/commit/54c03bbfba132d797b0efa1171ce3fdc6eb8af9e))
* **deps:** Bump github.com/runfinch/common-tests from 0.7.11 to 0.7.12 ([#761](https://github.com/sondavidb/finch/issues/761)) ([bb17a96](https://github.com/sondavidb/finch/commit/bb17a96b58b85c42fdc6fbd093209ce1ab900707))
* **deps:** Bump github.com/runfinch/common-tests from 0.7.13 to 0.7.14 ([#834](https://github.com/sondavidb/finch/issues/834)) ([2287575](https://github.com/sondavidb/finch/commit/22875751324666cb68f6ef928b9960b8fb9ede08))
...
* **deps:** Bump github.com/runfinch/common-tests from 0.7.2 to 0.7.3 ([#548](https://github.com/sondavidb/finch/issues/548)) ([a054ef3](https://github.com/sondavidb/finch/commit/a054ef3aa028b2c50fca93631a7b547b9c535f2e))
...
* **deps:** Bump github.com/runfinch/common-tests from 0.7.6 to 0.7.7 ([#609](https://github.com/sondavidb/finch/issues/609)) ([e21ae83](https://github.com/sondavidb/finch/commit/e21ae836d4f73ea07852e3cd1fc6cc16d56e4f32))
* **deps:** Bump github.com/runfinch/common-tests from 0.7.7 to 0.7.8 ([#617](https://github.com/sondavidb/finch/issues/617)) ([4d942f5](https://github.com/sondavidb/finch/commit/4d942f550c86106a224e97f32f1bf90f1b4d44cb))
* **deps:** Bump github.com/shirou/gopsutil/v3 from 3.23.10 to 3.23.11 ([#720](https://github.com/sondavidb/finch/issues/720)) ([defc6c5](https://github.com/sondavidb/finch/commit/defc6c55050dceab6273e501796b918ce8c86075))
* **deps:** Bump github.com/shirou/gopsutil/v3 from 3.23.11 to 3.23.12 ([#744](https://github.com/sondavidb/finch/issues/744)) ([eb55877](https://github.com/sondavidb/finch/commit/eb55877a330d4c45eb210a19188f54032d7f8274))
* **deps:** Bump github.com/shirou/gopsutil/v3 from 3.23.12 to 3.24.1 ([#787](https://github.com/sondavidb/finch/issues/787)) ([55f6d92](https://github.com/sondavidb/finch/commit/55f6d929949c1f776a63b93ea4a4446cc821e74a))
* **deps:** Bump github.com/shirou/gopsutil/v3 from 3.23.3 to 3.23.4 ([#389](https://github.com/sondavidb/finch/issues/389)) ([76b31c0](https://github.com/sondavidb/finch/commit/76b31c0c453935f22588523f65888e103581cd89))
* **deps:** Bump github.com/shirou/gopsutil/v3 from 3.23.4 to 3.23.5 ([#437](https://github.com/sondavidb/finch/issues/437)) ([8635294](https://github.com/sondavidb/finch/commit/8635294bcb22207bfdaa3f96756f93ba580ff6e2))
* **deps:** Bump github.com/shirou/gopsutil/v3 from 3.23.5 to 3.23.6 ([#464](https://github.com/sondavidb/finch/issues/464)) ([43a6720](https://github.com/sondavidb/finch/commit/43a672011fd47830073b8cc7427f82c6f1c3e5bd))
* **deps:** Bump github.com/shirou/gopsutil/v3 from 3.23.6 to 3.23.7 ([#513](https://github.com/sondavidb/finch/issues/513)) ([83bd718](https://github.com/sondavidb/finch/commit/83bd718be67ddba624e8218034c91bf399e2cccd))
* **deps:** Bump github.com/shirou/gopsutil/v3 from 3.23.7 to 3.23.8 ([#552](https://github.com/sondavidb/finch/issues/552)) ([cf9399a](https://github.com/sondavidb/finch/commit/cf9399a5dd125b875d6212b029ed19530898cdee))
* **deps:** Bump github.com/shirou/gopsutil/v3 from 3.23.8 to 3.23.9 ([#588](https://github.com/sondavidb/finch/issues/588)) ([20385b7](https://github.com/sondavidb/finch/commit/20385b7c5c0a45f5495615ebb3ce70220ab15969))
* **deps:** Bump github.com/shirou/gopsutil/v3 from 3.23.9 to 3.23.10 ([#678](https://github.com/sondavidb/finch/issues/678)) ([1b2b823](https://github.com/sondavidb/finch/commit/1b2b823da40454ac55b755145840bc5b03ab3091))
* **deps:** Bump github.com/shirou/gopsutil/v3 from 3.24.1 to 3.24.2 ([#838](https://github.com/sondavidb/finch/issues/838)) ([d2612aa](https://github.com/sondavidb/finch/commit/d2612aa7683e93213e0ba5f9e082afb343ddcaf2))
...
* **deps:** Bump github.com/sirupsen/logrus from 1.9.0 to 1.9.1 ([#405](https://github.com/sondavidb/finch/issues/405)) ([05b6b2e](https://github.com/sondavidb/finch/commit/05b6b2e7364036a3d30b67ad409f55526cc59ffe))
* **deps:** Bump github.com/sirupsen/logrus from 1.9.1 to 1.9.2 ([#408](https://github.com/sondavidb/finch/issues/408)) ([0ff477a](https://github.com/sondavidb/finch/commit/0ff477ab32e2c427bbc800b6ae65efc72b5ed1eb))
* **deps:** Bump github.com/sirupsen/logrus from 1.9.2 to 1.9.3 ([#446](https://github.com/sondavidb/finch/issues/446)) ([1823677](https://github.com/sondavidb/finch/commit/18236774d971065dec28d1db204e1f697d418a9b))
* **deps:** Bump github.com/spf13/afero from 1.10.0 to 1.11.0 ([#705](https://github.com/sondavidb/finch/issues/705)) ([928574f](https://github.com/sondavidb/finch/commit/928574f45f5990627d469a4d5074ef3de104519c))
* **deps:** Bump github.com/spf13/cobra from 1.7.0 to 1.8.0 ([#686](https://github.com/sondavidb/finch/issues/686)) ([00ba174](https://github.com/sondavidb/finch/commit/00ba174ad1c59981f6ce48bf80fc7e41cfed301b))
...
* **deps:** Bump github.com/stretchr/testify from 1.8.2 to 1.8.4 ([#429](https://github.com/sondavidb/finch/issues/429)) ([0f7750e](https://github.com/sondavidb/finch/commit/0f7750ebeee01108a9f6a6fcfe0c7f5f044bc336))
* **deps:** Bump github.com/stretchr/testify from 1.8.4 to 1.9.0 ([#839](https://github.com/sondavidb/finch/issues/839)) ([9f0953d](https://github.com/sondavidb/finch/commit/9f0953d260c806b4b243472ddce14284b2051a3e))
...
* **deps:** Bump golang.org/x/crypto from 0.10.0 to 0.11.0 ([#465](https://github.com/sondavidb/finch/issues/465)) ([dc5a3e7](https://github.com/sondavidb/finch/commit/dc5a3e7240d4af6b63874e239bc77bed04d2a0a6))
* **deps:** Bump golang.org/x/crypto from 0.12.0 to 0.13.0 ([#558](https://github.com/sondavidb/finch/issues/558)) ([f24264d](https://github.com/sondavidb/finch/commit/f24264d30805252d91b531c2bca8d9c883b88196))
* **deps:** Bump golang.org/x/crypto from 0.14.0 to 0.15.0 ([#692](https://github.com/sondavidb/finch/issues/692)) ([fba68ff](https://github.com/sondavidb/finch/commit/fba68ff03c01032665793b0f27681173ec03ceec))
* **deps:** Bump golang.org/x/crypto from 0.15.0 to 0.16.0 ([#704](https://github.com/sondavidb/finch/issues/704)) ([f6a920f](https://github.com/sondavidb/finch/commit/f6a920fc80bf7be954527fe5bd765dddcd0d5db5))
* **deps:** Bump golang.org/x/crypto from 0.16.0 to 0.18.0 ([#751](https://github.com/sondavidb/finch/issues/751)) ([fc434ac](https://github.com/sondavidb/finch/commit/fc434ac4f288bb1d2eeef3c2e2bcb186e8aa5278))
* **deps:** Bump golang.org/x/crypto from 0.18.0 to 0.19.0 ([#806](https://github.com/sondavidb/finch/issues/806)) ([3fbc87c](https://github.com/sondavidb/finch/commit/3fbc87ce7e6a07a789674a52fb79f968db267951))
* **deps:** Bump golang.org/x/crypto from 0.19.0 to 0.20.0 ([#833](https://github.com/sondavidb/finch/issues/833)) ([1ed1474](https://github.com/sondavidb/finch/commit/1ed1474fa7eaca97e32a7641da76ca96e5d300d1))
* **deps:** Bump golang.org/x/crypto from 0.20.0 to 0.21.0 ([#843](https://github.com/sondavidb/finch/issues/843)) ([b7ef6f2](https://github.com/sondavidb/finch/commit/b7ef6f2a946b1a813dd5846e4ea8726a1442b332))
...
* **deps:** Bump golang.org/x/crypto from 0.8.0 to 0.9.0 ([#397](https://github.com/sondavidb/finch/issues/397)) ([f15c2ee](https://github.com/sondavidb/finch/commit/f15c2ee576416c0cb25de45438bd894ca6b1fdcb))
* **deps:** Bump golang.org/x/crypto from 0.9.0 to 0.10.0 ([#451](https://github.com/sondavidb/finch/issues/451)) ([fef6e77](https://github.com/sondavidb/finch/commit/fef6e772c28429ef14068702c1dfd8e9fec2dea1))
* **deps:** Bump golang.org/x/image from 0.0.0-20210220032944-ac19c3e999fb to 0.10.0 ([#752](https://github.com/sondavidb/finch/issues/752)) ([9a08b45](https://github.com/sondavidb/finch/commit/9a08b45466cc58326df05d94dfe91edd07158759))
...
* **deps:** Bump golang.org/x/tools from 0.10.0 to 0.11.0 ([#466](https://github.com/sondavidb/finch/issues/466)) ([a8b32f9](https://github.com/sondavidb/finch/commit/a8b32f9674f93cfe54686a2e29b4cf6ca4534939))
* **deps:** Bump golang.org/x/tools from 0.11.0 to 0.11.1 ([#509](https://github.com/sondavidb/finch/issues/509)) ([e826bcf](https://github.com/sondavidb/finch/commit/e826bcff385946bb6629db8935d3aa912befb5bb))
* **deps:** Bump golang.org/x/tools from 0.11.1 to 0.12.0 ([#523](https://github.com/sondavidb/finch/issues/523)) ([09d6514](https://github.com/sondavidb/finch/commit/09d6514bfba31a898e3b3407964113f21fb6b244))
* **deps:** Bump golang.org/x/tools from 0.12.0 to 0.13.0 ([#559](https://github.com/sondavidb/finch/issues/559)) ([0f56d23](https://github.com/sondavidb/finch/commit/0f56d23b4e9210960c02822cd19a8a47326caa0e))
* **deps:** Bump golang.org/x/tools from 0.13.0 to 0.14.0 ([#610](https://github.com/sondavidb/finch/issues/610)) ([8938cf3](https://github.com/sondavidb/finch/commit/8938cf394f12b42da976c2963fad82c42a52aa85))
* **deps:** Bump golang.org/x/tools from 0.14.0 to 0.16.0 ([#706](https://github.com/sondavidb/finch/issues/706)) ([6f021a2](https://github.com/sondavidb/finch/commit/6f021a29fbabb35ef3b5b406d10932c81d2bd0c3))
* **deps:** Bump golang.org/x/tools from 0.16.0 to 0.16.1 ([#734](https://github.com/sondavidb/finch/issues/734)) ([efecfca](https://github.com/sondavidb/finch/commit/efecfcae8922f47581a4575125acbe375a706b11))
* **deps:** Bump golang.org/x/tools from 0.16.1 to 0.17.0 ([#757](https://github.com/sondavidb/finch/issues/757)) ([89623da](https://github.com/sondavidb/finch/commit/89623dab53f0128c1616c66a7361a5ce3df847c3))
* **deps:** Bump golang.org/x/tools from 0.17.0 to 0.18.0 ([#807](https://github.com/sondavidb/finch/issues/807)) ([7323751](https://github.com/sondavidb/finch/commit/7323751937900df76b217736acc51d77b9cff3d9))
* **deps:** Bump golang.org/x/tools from 0.18.0 to 0.19.0 ([#844](https://github.com/sondavidb/finch/issues/844)) ([f8883b2](https://github.com/sondavidb/finch/commit/f8883b2535e9fb655eaf86f0765e4f46d5d83b0a))
...
* **deps:** Bump golang.org/x/tools from 0.9.1 to 0.9.3 ([#443](https://github.com/sondavidb/finch/issues/443)) ([b192874](https://github.com/sondavidb/finch/commit/b192874e2b1c5de1c2148813760cbe65e15d7553))
* **deps:** Bump golang.org/x/tools from 0.9.3 to 0.10.0 ([#455](https://github.com/sondavidb/finch/issues/455)) ([e321f1d](https://github.com/sondavidb/finch/commit/e321f1dc607626a7f65b33e0a0f503d8c856b1f2))
* **deps:** Bump google.golang.org/grpc from 1.53.0 to 1.56.3 ([#658](https://github.com/sondavidb/finch/issues/658)) ([321487c](https://github.com/sondavidb/finch/commit/321487c9309a73625512255ff86b6ffc6977b86e))
* **deps:** Bump google.golang.org/protobuf from 1.32.0 to 1.33.0 ([#858](https://github.com/sondavidb/finch/issues/858)) ([14532d5](https://github.com/sondavidb/finch/commit/14532d599ce17767d8e9ccb2ca3450621e719cc7))
* **deps:** Bump k8s.io/apimachinery from 0.27.1 to 0.27.2 ([#407](https://github.com/sondavidb/finch/issues/407)) ([e6cbd2c](https://github.com/sondavidb/finch/commit/e6cbd2c5dba8af5cab9ea8a37a33c580ee4edef9))
* **deps:** Bump k8s.io/apimachinery from 0.27.2 to 0.27.3 ([#454](https://github.com/sondavidb/finch/issues/454)) ([d6746a4](https://github.com/sondavidb/finch/commit/d6746a447e10bed6c13d197c8d693b27e02ac3aa))
* **deps:** Bump k8s.io/apimachinery from 0.27.3 to 0.27.4 ([#487](https://github.com/sondavidb/finch/issues/487)) ([444bbc0](https://github.com/sondavidb/finch/commit/444bbc0779dbe22207fec471389810e398c1cf50))
* **deps:** Bump k8s.io/apimachinery from 0.27.4 to 0.28.0 ([#535](https://github.com/sondavidb/finch/issues/535)) ([8df84cf](https://github.com/sondavidb/finch/commit/8df84cf8c54bd772c28a83df918c251a540c881a))
* **deps:** Bump k8s.io/apimachinery from 0.28.0 to 0.28.1 ([#543](https://github.com/sondavidb/finch/issues/543)) ([675f76f](https://github.com/sondavidb/finch/commit/675f76fa6d8874587c09237faeb82d9f96c14adb))
* **deps:** Bump k8s.io/apimachinery from 0.28.1 to 0.28.2 ([#568](https://github.com/sondavidb/finch/issues/568)) ([915d658](https://github.com/sondavidb/finch/commit/915d658fbd6581eec437f2c31121366ff77a5981))
* **deps:** Bump k8s.io/apimachinery from 0.28.2 to 0.28.3 ([#652](https://github.com/sondavidb/finch/issues/652)) ([05f9d53](https://github.com/sondavidb/finch/commit/05f9d53dab468546918a332f0fc18449de774487))
* **deps:** Bump k8s.io/apimachinery from 0.28.3 to 0.28.4 ([#697](https://github.com/sondavidb/finch/issues/697)) ([e064d94](https://github.com/sondavidb/finch/commit/e064d94b71acbd7d160c3f061ff3ade7caae3333))
* **deps:** Bump k8s.io/apimachinery from 0.29.1 to 0.29.2 ([#820](https://github.com/sondavidb/finch/issues/820)) ([6ca0f7f](https://github.com/sondavidb/finch/commit/6ca0f7ff007f88ad37eb02b2c9437042a7350f37))
...
* **deps:** Bump lima version ([#476](https://github.com/sondavidb/finch/issues/476)) ([7b330d3](https://github.com/sondavidb/finch/commit/7b330d3e2bd4cc623f46762c8e3b120ddc18f3b0))
* **deps:** Bump submodules ([#375](https://github.com/sondavidb/finch/issues/375)) ([70fe4c3](https://github.com/sondavidb/finch/commit/70fe4c3e0320f237d2e4501fbe2bc4d3320ef3e9))
* **deps:** Bump submodules ([#402](https://github.com/sondavidb/finch/issues/402)) ([06d86b2](https://github.com/sondavidb/finch/commit/06d86b2bc348db9f0d8d02678faee556719b883d))
* **deps:** Bump submodules ([#439](https://github.com/sondavidb/finch/issues/439)) ([e9551b5](https://github.com/sondavidb/finch/commit/e9551b50010deb43ad26dcd3671ec2f246e84ed6))
* **deps:** Bump submodules ([#482](https://github.com/sondavidb/finch/issues/482)) ([92f2494](https://github.com/sondavidb/finch/commit/92f2494f17bde67b785ccf444ac6525b7a856a6c))
...
* **deps:** Bump submodules and dependencies ([#521](https://github.com/sondavidb/finch/issues/521)) ([1b3ad94](https://github.com/sondavidb/finch/commit/1b3ad94f9477eb3f8d33cbea90880f78ca403ff7))
* **deps:** Bump submodules and dependencies ([#544](https://github.com/sondavidb/finch/issues/544)) ([94b7497](https://github.com/sondavidb/finch/commit/94b74978e135fbf6375fe1a21ce4b64b77db5ee7))
* **deps:** Bump submodules and dependencies ([#551](https://github.com/sondavidb/finch/issues/551)) ([baf645f](https://github.com/sondavidb/finch/commit/baf645f250344a42bc4ee3ea53e97b2c82dbb55a))
* **deps:** Bump submodules and dependencies ([#565](https://github.com/sondavidb/finch/issues/565)) ([c02413f](https://github.com/sondavidb/finch/commit/c02413f47ade25232830a04548625297267caf9f))
* **deps:** Bump submodules and dependencies ([#567](https://github.com/sondavidb/finch/issues/567)) ([f70314e](https://github.com/sondavidb/finch/commit/f70314ef4a517d1fb69dc8444e621262f7e4dcd0))
* **deps:** Bump submodules and dependencies ([#637](https://github.com/sondavidb/finch/issues/637)) ([b094751](https://github.com/sondavidb/finch/commit/b094751d3ba56c7855fc6f3af7b8bef2618a7206))
* **deps:** Bump submodules and dependencies ([#722](https://github.com/sondavidb/finch/issues/722)) ([667c692](https://github.com/sondavidb/finch/commit/667c6923478696da86f3b899edf9a0efdc7c7b9c))
* **deps:** Bump submodules and dependencies ([#724](https://github.com/sondavidb/finch/issues/724)) ([bb1a273](https://github.com/sondavidb/finch/commit/bb1a273e0b966599d77dd649002e2896ed8b98e5))
* **deps:** Bump submodules and dependencies ([#733](https://github.com/sondavidb/finch/issues/733)) ([8b2d8cd](https://github.com/sondavidb/finch/commit/8b2d8cddc7fc63264c7f5bf1be2bd4417a92aaeb))
* **deps:** Bump submodules and dependencies ([#762](https://github.com/sondavidb/finch/issues/762)) ([4889527](https://github.com/sondavidb/finch/commit/4889527dae6494509fce0b3fefc4ac890d113f11))
* **deps:** Bump submodules and dependencies ([#795](https://github.com/sondavidb/finch/issues/795)) ([ec77f1a](https://github.com/sondavidb/finch/commit/ec77f1abe9c00ddd9cd84ed665204c2c5df4c40b))
* **deps:** Bump submodules and dependencies ([#805](https://github.com/sondavidb/finch/issues/805)) ([0bf9148](https://github.com/sondavidb/finch/commit/0bf9148a6ce88dde413679cc9a3702a5d398d544))
* **deps:** Bump submodules and dependencies ([#825](https://github.com/sondavidb/finch/issues/825)) ([8828c56](https://github.com/sondavidb/finch/commit/8828c56251ea792efb9b8fccc8eadec374b30c62))
...
* make finch work on windows with wsl2 ([#649](https://github.com/sondavidb/finch/issues/649)) ([31cdc41](https://github.com/sondavidb/finch/commit/31cdc411d29758bae54a0b3fdb37be2777bd9fdc))
...
* adding config option for SOCI installation on VM ([#506](https://github.com/sondavidb/finch/issues/506)) ([a2e077b](https://github.com/sondavidb/finch/commit/a2e077b8f72dc8d8d833aedce31b3ad3f9f45eb4))
...
* ECR credential integration into Finch  ([#462](https://github.com/sondavidb/finch/issues/462)) ([d3514b3](https://github.com/sondavidb/finch/commit/d3514b3dbe69e1bed3d40838af01ebec184f7413))
...
* support push with SOCI ([#578](https://github.com/sondavidb/finch/issues/578)) ([69721b7](https://github.com/sondavidb/finch/commit/69721b76151a4c24d82cdc1c9338bacf72afb15d))
* supports adding files inside the VM to support bundles ([#549](https://github.com/sondavidb/finch/issues/549)) ([3b1df46](https://github.com/sondavidb/finch/commit/3b1df4697e7b020d6c7339fb71bacf62ca0b3ee0))
* upgrade Windows support to "feature" ([#778](https://github.com/sondavidb/finch/issues/778)) ([63894d1](https://github.com/sondavidb/finch/commit/63894d12f3ab9d2c02700779e42182d06019a85f))


### Bug Fixes

* Add cleanup script to Makefile ([#444](https://github.com/sondavidb/finch/issues/444)) ([da91f87](https://github.com/sondavidb/finch/commit/da91f87369e5fde221b8edbac374954e71dae947))
...
* add force to cni cleanup on boot service ([#785](https://github.com/sondavidb/finch/issues/785)) ([9b2438b](https://github.com/sondavidb/finch/commit/9b2438b5827706b134bb791a78643af37854b377))
...
* Change the default behavoir for deleting .finch folder to false when uninstall ([#732](https://github.com/sondavidb/finch/issues/732)) ([e818743](https://github.com/sondavidb/finch/commit/e8187432a02c59a821a0d3b39c9cbc51f75a60cd))
...
* Clean up all previous finch version installation registries in postinstall and uninstall ([#688](https://github.com/sondavidb/finch/issues/688)) ([9afc0b9](https://github.com/sondavidb/finch/commit/9afc0b9a5e73a3c261aeac87b977e44129b311bd))
* configure aws creds in sync submodules/deps action ([#518](https://github.com/sondavidb/finch/issues/518)) ([b67452e](https://github.com/sondavidb/finch/commit/b67452e012d5d00f2ff66e023b4672f7957fe625))
* Correct typo in type name of struct (NerdctlClientOuput) ([#743](https://github.com/sondavidb/finch/issues/743)) ([13de2b9](https://github.com/sondavidb/finch/commit/13de2b99fcd6f952beda9f75e6f3660974a815d0))
* ecr credential helper hash check ([#668](https://github.com/sondavidb/finch/issues/668)) ([4b1b0a2](https://github.com/sondavidb/finch/commit/4b1b0a2fa515bcfaaa6784ffa53a5918245cbd72))
* ecr creds helper and credential_process ([#510](https://github.com/sondavidb/finch/issues/510)) ([0525753](https://github.com/sondavidb/finch/commit/0525753105403e27e5d1372588c0c87aa6b6cbe6))
...
* enables bridge-nf-call-iptables by default ([#539](https://github.com/sondavidb/finch/issues/539)) ([6ea1499](https://github.com/sondavidb/finch/commit/6ea1499c1320545ba4efe8a7820dcf0998e28782))
* Env variable CONTAINERD_SNAPSHOTTER cleared on overlayfs and ref… ([#816](https://github.com/sondavidb/finch/issues/816)) ([d222a34](https://github.com/sondavidb/finch/commit/d222a347632f9898ed223a122c97d3a973bde3a5))
* Fix to be able to run finch build with --ssh option ([#696](https://github.com/sondavidb/finch/issues/696)) ([4d1e6cf](https://github.com/sondavidb/finch/commit/4d1e6cf6d8f4b6f2cbdf0229e8dcf4ad0c80d80c))
* Fix to delete ~/.finch when uninstalling finch ([#703](https://github.com/sondavidb/finch/issues/703)) ([8d7389f](https://github.com/sondavidb/finch/commit/8d7389f607fc0211ebd6cfafe13197b945d877a3))
* give pull request write permissions to sync job ([#520](https://github.com/sondavidb/finch/issues/520)) ([55b5235](https://github.com/sondavidb/finch/commit/55b5235d50feb6557108c00cd8543d21f1fdf315))
* give token write perms to sync-submodules ([#519](https://github.com/sondavidb/finch/issues/519)) ([8b639ea](https://github.com/sondavidb/finch/commit/8b639eac14691caa99a6bfddd61be0b811a796d9))
...
* improve creds helper UX ([#673](https://github.com/sondavidb/finch/issues/673)) ([bc238cf](https://github.com/sondavidb/finch/commit/bc238cf9383d0fbc983a7f76f2cc15821eafd265))
...
* **Makefile:** use POSIX tar syntax for stdin ([#529](https://github.com/sondavidb/finch/issues/529)) ([e222131](https://github.com/sondavidb/finch/commit/e2221310e1725b3a6072abe12e72f01859ce3320))
* Mount /var/folders to finch vm ([#525](https://github.com/sondavidb/finch/issues/525)) ([c97d2e9](https://github.com/sondavidb/finch/commit/c97d2e93edaf139c3960620ec00454f856a8daee))
* msi release tests cleanup ([#819](https://github.com/sondavidb/finch/issues/819)) ([0f23660](https://github.com/sondavidb/finch/commit/0f236609429534bab3057971e6126cf9b3ff47fc))
* option to use installed lima for SOCI e2e tests ([#533](https://github.com/sondavidb/finch/issues/533)) ([8b66659](https://github.com/sondavidb/finch/commit/8b666590631235f6430d652d5c50f0047a120893))
...
* properly reload persistent snapshotter data and restart services ([#767](https://github.com/sondavidb/finch/issues/767)) ([700cb92](https://github.com/sondavidb/finch/commit/700cb92da72510b47498c48f188c50806382a291))
* quote recursive calls to make ([#515](https://github.com/sondavidb/finch/issues/515)) ([d603096](https://github.com/sondavidb/finch/commit/d6030965414e80e1f3c550e67097ce5f34aeff41))
...
* remove virtual machine image when running make clean ([98c8ee4](https://github.com/sondavidb/finch/commit/98c8ee4f783d01cb1340e77b508d868c3bb4bf04))
* Reset disks and force remove vm after suite execution ([#846](https://github.com/sondavidb/finch/issues/846)) ([c2363b1](https://github.com/sondavidb/finch/commit/c2363b18dc9531d81898dbbce131d13205e40017))
* resolve shellcheck warnings ([#684](https://github.com/sondavidb/finch/issues/684)) ([d9f695a](https://github.com/sondavidb/finch/commit/d9f695a39f17af6ab00722fbf5191b6fa5c9166b))
* Restart buildkit after containerd when provisioning ([#461](https://github.com/sondavidb/finch/issues/461)) ([fca1828](https://github.com/sondavidb/finch/commit/fca182877ca616257527f6186dd1e88b2919feeb))
* run SOCI as a systemd service ([#667](https://github.com/sondavidb/finch/issues/667)) ([24fd649](https://github.com/sondavidb/finch/commit/24fd649152b3ca18a1024d3a2ea40806c0c96cf2))
* soci being reset on vm stop/start ([#672](https://github.com/sondavidb/finch/issues/672)) ([9df7d32](https://github.com/sondavidb/finch/commit/9df7d325b25fe98fdb8327bc4603ae4441b6a190))
* sort volume args in DOCKER_COMPAT mode ([#417](https://github.com/sondavidb/finch/issues/417)) ([6a8ca1a](https://github.com/sondavidb/finch/commit/6a8ca1a559dada6ed320c9454fbc3229446a0a40))
* stop Finch on uninstall ([#818](https://github.com/sondavidb/finch/issues/818)) ([a96788b](https://github.com/sondavidb/finch/commit/a96788bbce5e9a6af805650a1c21d1c60e04fa68))
* Stop lima process in postinstall and uninstall ([#438](https://github.com/sondavidb/finch/issues/438)) ([975c4ee](https://github.com/sondavidb/finch/commit/975c4ee42c1529673a51382c62c4096dc663f80a))
* temporarily switch to our own nerdctl-full bundle with patched runc and buildkit ([#783](https://github.com/sondavidb/finch/issues/783)) ([f677e2e](https://github.com/sondavidb/finch/commit/f677e2e03c7ee94e18ea990c1723f41bac660698))
...
* Use LimaUser method instead of host user name ([#712](https://github.com/sondavidb/finch/issues/712)) ([7c02e08](https://github.com/sondavidb/finch/commit/7c02e08394f667e1f69cd304ef0258c1f0ff1c0f))
...
* **windows-installer:** add new cleanup script on install ([#824](https://github.com/sondavidb/finch/issues/824)) ([fccfa1d](https://github.com/sondavidb/finch/commit/fccfa1dd5773242039254e067dcde0cd9fd4fe5e))
* **windows-installer:** ignore FilesInUse/Restart dialogue ([#823](https://github.com/sondavidb/finch/issues/823)) ([f64835d](https://github.com/sondavidb/finch/commit/f64835d6b7d473eda434cbb932d3c049cac6a5d5))
* **windows-installer:** uninstall script behavior ([#822](https://github.com/sondavidb/finch/issues/822)) ([ace37ea](https://github.com/sondavidb/finch/commit/ace37eaf48fca613f692e7a08b182d268fc60555))


### Reverts

* "always force stop when using Virtualization.framework" ([#370](https://github.com/sondavidb/finch/issues/370)) ([cb3051e](https://github.com/sondavidb/finch/commit/cb3051e60d80aabce550377696d4251c9a9b0eec))
* "chore(main): release 1.0.1" ([#727](https://github.com/sondavidb/finch/issues/727)) ([52e08d2](https://github.com/sondavidb/finch/commit/52e08d27d8a29b4988cb228d3d270d85ba54337a))
* "fix: resolve shellcheck warnings" ([#725](https://github.com/sondavidb/finch/issues/725)) ([8ea255a](https://github.com/sondavidb/finch/commit/8ea255abb64c653a8c35e82c9c17aec9904278c5))
...
* update Release-As version to 1.0.0 (not-squashed) ([2c97323](https://github.com/sondavidb/finch/commit/2c97323deccfbc860e304b3297c8e51f91b7e2c0))
* update Release-As version to 1.0.1 ([#731](https://github.com/sondavidb/finch/issues/731)) ([8fd5a70](https://github.com/sondavidb/finch/commit/8fd5a705e01823d159d1c48b06a8d7bc84f61ee3))
